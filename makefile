...
bin/M: src/M.c src/common.c
	mkdir -p bin
	gcc -o bin/M src/M.c src/common.c -I.

bin/P: src/P.c src/common.c src/dataprotocol.c
	mkdir -p bin
	gcc -o bin/P src/P.c src/common.c src/dataprotocol.c -I.

bin/Q: src/Q.c src/common.c src/dataprotocol.c
	mkdir -p bin
	gcc -o bin/Q src/Q.c src/common.c src/dataprotocol.c -I.

bin/A: src/A.c src/common.c
	mkdir -p bin
	gcc -o bin/A src/A.c src/common.c -I.
